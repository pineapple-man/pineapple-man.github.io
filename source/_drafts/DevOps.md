...
## DevOps 的历程
DevOps的历程始于2009年，在成功地应用了Agile，Scrum和XP等方法论后，我们的
客户能提供很炫酷的web交互服务，可覆盖从传统PC到iPhone移动设备的各种终端。
Scrum团队能已够更快地开发和发布软件。即使开发时间减少了一半，但是业务主管仍
然对业务速度的提升表示不满。
表面上看起来还是开发过程是瓶颈，但是在调查中发现开发过程并非瓶颈，相反是业务
流程应该被改进。
