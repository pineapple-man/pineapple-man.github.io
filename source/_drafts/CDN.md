...
:notes:使用CDN的第一个也是最重要的原因：<font style="color:red;font-weight:bold">为了加速网站的访问</font>
...
:persevere:CDN虽然有很多的优点，但它并不是万能的，在部分场景下，CDN并不是适用
